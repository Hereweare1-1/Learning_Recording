...
True
```
- **\_\_ls\_\_:** 自己设定判断两个对象大小的规则
```
#other表示另一个对象,这里规定根据price这个属性来比较两个对象的大小
def __lt__(self,other):  
    return self.price<other.price
    
c1=Car("白色","X7","奔驰",100000)  
c2=Car("红色","X8","雅迪",5000)
...
- 定义在初始化方法外面
- 通过**类名.属性**来操作
![file-20260907205925262](assets/面向对象基础/file-20260907205925262.png)

- 说明：如果通过**对象名.属性** 查找 `print(c1.wheel)`会先查找实例属性，如果没有在查找类属性